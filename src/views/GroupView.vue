...
const InviteSheet = defineAsyncComponent(() => import('../components/InviteSheet.vue'));
const GroupIconPicker = defineAsyncComponent(() => import('../components/GroupIconPicker.vue'));
